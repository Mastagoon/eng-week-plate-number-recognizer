...
GPIO.setup(21, GPIO.OUT, initial=GPIO.LOW) # unliscenced LED
...
def ledControl():
    ...
    try:
        while flag:
            ...
            # Check if liscenced [Masta]
            if(text in licensedList):
                display="Licensed!"
                text_surface = my_font.render(display, True, WHITE)#display Left servo History coloum
...
# We won't need this because we're not using any servo motors [Masta]
# def servoControl():
